...
const FornecedorForm = () => {
  ...
  const handleCepChange = (e) => {
    const cep = e.target.value.replace(/\D/g, '') //Expressão regular (Regex) - Remove caracteres não numéricos do CEP
        ...
        {tooltipAberto && (<div className="tooltip">
          {
            id ? 'Nesta tela, você pode editar as informações de um fornecedor existente.'
              : 'Neste tela, você pode adicionar um novo fornecedor ao sistema.'
          }
        </div>
        )}
      </h2>
      ...
      <form onSubmit={handleSubmit} className="fornecedor-form">
        ...
        <div className="form-group">
          ...
          <input
            ...
            id="email"
            name="email"
            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" //Rigex
      ...
      >
        <div className="modalContent">
          ...
          <div className="modalButtons">
            ...
            className="btn-success">Fechar</button>
            { !id && <button onClick={adicionarOutroFornecedor}
            className="btn-secondary">Adicionar outro fornecedor</button>}
          </div>
        </div>
      </Modal>
